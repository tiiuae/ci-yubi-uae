...
def VerifySignature(req: func.HttpRequest) -> func.HttpResponse:
    ...
    try:
        ...
        if not all(field in req_body for field in ['certificateName', 'Signature', 'Hash']):
            return func.HttpResponse(
                body=json.dumps({'error': 'Missing required fields', 'message': 'Expected certificateName, Signature, and Hash'}),
